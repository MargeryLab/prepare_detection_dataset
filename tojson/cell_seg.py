...
ROOT_DIR = '../'
DATA_DIR = '/media/margery/4ABB9B07DF30B9DB/MedicalImagingDataset/nucleiSeg/cell_test_img'
ANNOTATION_TUMOR_DIR = '/media/margery/4ABB9B07DF30B9DB/MedicalImagingDataset/nucleiSeg/cell_test_mask'

INFO = {
    "description": "Nuclei Segmentation Dataset",
...
def main():
    ...
    with open('{}/nuclei_seg_test.json'.format(ROOT_DIR), 'w') as output_json_file:
