...
"""
ROOT_DIR = './'
DATA_DIR = '/media/dell/EC88D61288D5DAE2/Datasets/ISIC-2017_Test_v2_Data'
ANNOTATION_TUMOR_DIR = '/media/dell/EC88D61288D5DAE2/Datasets/ISIC-2017_Test_v2_Part1_GroundTruth'

INFO = {
    "description": "ISIC-2017 Dataset",
...
def main():
    ...
    # data_list = [l.strip('\n') for l in open(os.path.join(DATA_DIR,'test.txt')).readlines()]
    data_list = [file for file in os.listdir(DATA_DIR)]
    data_list = filter_for_jpeg(DATA_DIR, data_list)
    for i in range(len(data_list)):
        image = Image.open(data_list[i])
