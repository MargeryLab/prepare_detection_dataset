...
ROOT_DIR = './'
DATA_DIR = '/media/margery/4ABB9B07DF30B9DB/MedicalImagingDataset/Finding lungs in CT data/data/finding-lungs-in-ct-data/train/raw'
ANNOTATION_TUMOR_DIR = './train_tumor_mask'

INFO = {
    "description": "Lung Segmentation Dataset",
